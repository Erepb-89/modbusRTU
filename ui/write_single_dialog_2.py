...
class Ui_WriteRegDialog_2(QDialog):
    ...
    def set_write_params(self):
        self.parent.slave2.write_reg_params['slave_id'] = int(self.SlaveID.toPlainText())
        self.parent.slave2.write_reg_params['registeraddress'] = int(self.Address.toPlainText())
        self.parent.slave2.write_reg_params['value'] = float(self.Value.toPlainText())
        self.parent.slave2.write_reg_params['number_of_decimals'] = int(self.Decimals.toPlainText())
        self.parent.slave2.write_reg_params['signed'] = bool(self.checkBoxSigned.isChecked())

        selected_func = self.comboFunctionCode.itemText(
            self.comboFunctionCode.currentIndex()).split(" ")[0]
        self.parent.slave2.write_reg_params['functioncode'] = int(selected_func)

        self.write()

    def write(self):
        self.parent.write_register_2()
